...
import com.database.concurrency.*;
import com.database.table.*;
import com.database.table.Record;
import com.database.cli.parser.ASTExecutableStatement;
import com.database.cli.parser.ParseException;
import com.database.cli.parser.RookieParser;
import com.database.cli.visitor.ExecutableStatementVisitor;
...
import com.database.index.BPlusTree;
import com.database.index.BPlusTreeMetadata;
...
import com.database.memory.EvictionPolicy;
import com.database.query.QueryPlan;
import com.database.query.SequentialScanOperator;
import com.database.query.SortOperator;
import com.database.query.expr.Expression;
import com.database.recovery.ARIESRecoveryManager;
...
//                    lockContext.release(getTransaction());
//                }
                // 此时2PL的phrase阶段已经结束 要开始以一定的顺序释放锁
                // 获取当前事务所有的锁, LockContext中numChildren==0就是叶子, 由底层向上bfs
