...
import com.database.categories.Proj3Part1Tests;
...
import com.database.query.join.SortMergeOperator;
...
public class TestSortMergeJoin {
    ...
    @Test
    @Category(PublicTests.class)
    public void myTestSortMergeJoinUnsortedInputs()  {
        d.setWorkMem(3); // B=3
        try(Transaction transaction = d.beginTransaction()) {
            transaction.createTable(TestUtils.createSchemaWithAllTypes(), "leftTable");
            transaction.createTable(TestUtils.createSchemaWithAllTypes(), "rightTable");
            ...
            Record r7 = TestUtils.createRecordWithAllTypesWithValue(7);
            Record r8 = TestUtils.createRecordWithAllTypesWithValue(8);
            Record r9 = TestUtils.createRecordWithAllTypesWithValue(9);

            Record expectedRecord1 = r1.concat(r1);
            Record expectedRecord2 = r2.concat(r2);
            Record expectedRecord3 = r3.concat(r3);
            Record expectedRecord4 = r4.concat(r4);
            Record expectedRecord5 = r5.concat(r5);
            Record expectedRecord6 = r6.concat(r6);
            Record expectedRecord7 = r7.concat(r7);
            Record expectedRecord8 = r8.concat(r8);
            Record expectedRecord9 = r9.concat(r9);

            List<Record> leftTableRecords = new ArrayList<>();
            List<Record> rightTableRecords = new ArrayList<>();

            leftTableRecords.add(r1);
            leftTableRecords.add(r1);
            leftTableRecords.add(r2);
            leftTableRecords.add(r2);
            leftTableRecords.add(r3);
            leftTableRecords.add(r4);
            leftTableRecords.add(r4);
            leftTableRecords.add(r5);
            leftTableRecords.add(r5);
            leftTableRecords.add(r6);
            leftTableRecords.add(r7);
            leftTableRecords.add(r8);
            leftTableRecords.add(r9);
            leftTableRecords.add(r9);

            rightTableRecords.add(r1);
            rightTableRecords.add(r2);
            rightTableRecords.add(r2);
            rightTableRecords.add(r2);
            rightTableRecords.add(r4);
            rightTableRecords.add(r4);
            rightTableRecords.add(r4);
            rightTableRecords.add(r5);
            rightTableRecords.add(r6);
            rightTableRecords.add(r7);
            rightTableRecords.add(r8);
            rightTableRecords.add(r8);
            rightTableRecords.add(r9);
            rightTableRecords.add(r9);
            ...
            int numRecords = 0;
            List<Record> expectedRecord = new ArrayList<>();
            expectedRecord.add(r1.concat(r1));
            expectedRecord.add(r1.concat(r1));
            expectedRecord.add(r2.concat(r2));
            expectedRecord.add(r2.concat(r2));
            expectedRecord.add(r2.concat(r2));
            expectedRecord.add(r2.concat(r2));
            expectedRecord.add(r2.concat(r2));
            expectedRecord.add(r2.concat(r2));
            expectedRecord.add(r4.concat(r4));
            expectedRecord.add(r4.concat(r4));
            expectedRecord.add(r4.concat(r4));
            expectedRecord.add(r4.concat(r4));
            expectedRecord.add(r4.concat(r4));
            expectedRecord.add(r4.concat(r4));
            expectedRecord.add(r5.concat(r5));
            expectedRecord.add(r5.concat(r5));
            expectedRecord.add(r6.concat(r6));
            expectedRecord.add(r7.concat(r7));
            expectedRecord.add(r8.concat(r8));
            expectedRecord.add(r8.concat(r8));
            expectedRecord.add(r9.concat(r9));
            expectedRecord.add(r9.concat(r9));
            expectedRecord.add(r9.concat(r9));
            expectedRecord.add(r9.concat(r9));

            while (outputIterator.hasNext() && numRecords < 24) {

                Record r = outputIterator.next();
                assertEquals("mismatch at record " + numRecords, expectedRecord.get(numRecords), r);
                numRecords++;
            }


            assertFalse("too many records", outputIterator.hasNext());
            assertEquals("too few records", 24, numRecords);
        }
    }
