"""
A client for connecting to a sqldb server.
See src/main/java/com/database/cli/Server.java
for details
"""
import socket
import threading
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Connect to a sqldb server.")
